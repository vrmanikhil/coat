		...
		<div class="row">
			...
			<div class=" col-md-offset-2 col-md-5">
				<div class="row">
					...
					<div class="col-md-5">
						<input type="password" placeholder="PASSWORD" class="main-form main-form-2" style="width:100%;" id="login-form">
						<a href="#" class="forgot" id="forgot_password">Forgot Password?</a>
					</div>

					<div class="col-md-2" id="margin-add">
						<a href="#" class="button" id="signup">LOGIN</a>
				...
				<div class="col-md-4 signup-form">
					...
					<form>
						<div class="row">
							...
							<div class="col-md-6">
								<input type="text" placeholder="FIRST NAME" class="main-form">
							</div>

							<div class="col-md-6">
								<input type="text" placeholder="LAST NAME" class="main-form">
							</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<input type="email" placeholder="E-MAIL ADDRESS" class="main-form" style="width:100%;">
						...
						<div class="row">
							...
							<div class="col-md-10">
								<input type="number" placeholder="MOBILE NUMBER" class="main-form" style="width:100%;">
							</div>
						...
						<div class="row">
							...
							<div class="col-md-8">
								<input type="password" placeholder="PASSWORD" class="main-form" style="width:100%;">
							</div>

							<div class="col-md-4 dropdown" style="padding-left: 0px;padding-right: 15px;">
								<select style="width:100%;">
									<option for="GENDER">GENDER</option>
						...
						<div class="row">
							...
							<div class="col-md-7 dropdown">
								<select>
									<option for="CHOOSE COURSE">CHOOSE COURSE</option>
									<option for="B.TECH- COMPUTER SCIENCE">B.TECH- COMPUTER SCIENCE</option>
									<option for="B.TECH- COMPUTER SCIENCE">B.TECH- COMPUTER SCIENCE</option>
									<option for="B.TECH- COMPUTER SCIENCE">B.TECH- COMPUTER SCIENCE</option>
								</select>
							</div>
							...
							<div class="col-md-5 dropdown">
								<select>
									<option for="CHOOSE BATCH">CHOOSE BATCH</option>
									<option for="2013-2017">2013-2017</option>
									<option for="2014-2018">2014-2018</option>
								</select>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-12" style="text-align:center;">
								...
								<a href="#" class="button button-2">REGISTER</a>
							</div>
